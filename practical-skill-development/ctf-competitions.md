...
A useful platform for keeping up to date with new competitions is [_CTFtime_](http://ctftime.org/)

## <mark style="color:blue;">Challenge Categories</mark>

For the challenges encountered in this type of competition, we can find several categories as follows:
