...
**Common Vulnerabilities and Exposures (CVEs)** is a standard to identify and categorize known vulnerabilities. They follow the structure _CVE-YEAR-IDNUMBER_, for example, _CVE-2017-0144_ is associated with the famous vulnerability _EternalBlue._
...
<figure><img src="../../.gitbook/assets/image (1) (1) (2).png" alt=""><figcaption><p><a href="https://www.first.org/cvss/v3-1/media/MetricGroups.svg">https://www.first.org/cvss/v3-1/media/MetricGroups.svg</a></p></figcaption></figure>
