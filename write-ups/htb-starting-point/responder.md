...
{% hint style="success" %}
To learn more about Local File Inclusion and its exploitation, you can go [here](../../web-exploitation/web-vulnerabilities/local-file-inclusion-wip.md)
{% endhint %}
...
{% hint style="success" %}
To learn more about Remote File Inclusion and its exploitation, you can go [here](../../web-exploitation/web-vulnerabilities/remote-file-inclusion-wip.md)
{% endhint %}
