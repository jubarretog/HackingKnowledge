...
{% hint style="success" %}
To learn more about Cross-Site Scripting (XSS) attacks, you can go [here](../../web-exploitation/web-vulnerabilities/cross-site-scripting-wip.md), and to learn more about Server-Side Template Injection (SSTI) attacks, you can go [here](../../web-exploitation/web-vulnerabilities/server-side-template-injection-wip.md)
{% endhint %}
