...
{% hint style="success" %}
To learn the complete process for the _Log4Shell_ vulnerability and its exploitation, you can go [here](../../web-exploitation/web-vulnerabilities/cve-log4shell-wip.md)
{% endhint %}
