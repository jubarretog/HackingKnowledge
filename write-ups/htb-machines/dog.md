...
{% hint style="success" %}
To learn more about how to craft and use a Reverse Shell properly, you can go [here](../../penetration-testing/process-stages/exploitation/scripting/reverse-shell.md)
{% endhint %}
