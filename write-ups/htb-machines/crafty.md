...
{% hint style="success" %}
To learn more about the _Log4Shell_ vulnerability and its exploitation, you can go [here](../../web-exploitation/web-vulnerabilities/cve-log4shell-wip.md)
{% endhint %}
...
* I checked the permissions we had on the folder, but we didn't have writing permissions, so we couldn't export or copy the content of the file. So I went to the root folder and created a _Temp_ folder, which will give me this advantage, then copied the file there and used [_certutil_](../../active-directory-hacking/tools-and-utilities-wip.md#certutil) to encode its content to base64 to prepare it for the transfer
