...
{% hint style="success" %}
To learn more about Local File Inclusion exploitation, you can go [here](../../web-exploitation/web-vulnerabilities/local-file-inclusion-wip.md)
{% endhint %}
...
{% hint style="success" %}
To learn more about the Reverse Shell and how to script it, you can go [here](../../penetration-testing/process-stages/exploitation/scripting/reverse-shell.md)
{% endhint %}
